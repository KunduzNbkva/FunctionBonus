...
class MinutesAdapter() : RecyclerView.Adapter<MinutesAdapter.MinutesViewHolder>() {
    ...
    override fun onCreateViewHolder(
        ...
        return MinutesViewHolder(itemView)
    }
    ...
    inner class MinutesViewHolder(itemView: View?) : RecyclerView.ViewHolder(itemView!!) {
